...
export declare type StableTokenContract = CeloContract.StableToken | CeloContract.StableTokenEUR;
export declare type ExchangeContract = CeloContract.Exchange | CeloContract.ExchangeEUR;
